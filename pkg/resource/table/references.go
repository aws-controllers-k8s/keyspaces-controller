...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.EncryptionSpecification != nil {
		if desiredKO.Spec.EncryptionSpecification.KMSKeyIdentifierRef != nil {
			if latestKO.Spec.EncryptionSpecification == nil {
				latestKO.Spec.EncryptionSpecification = &svcapitypes.EncryptionSpecification{}
			}
			if latestKO.Spec.EncryptionSpecification.KMSKeyIdentifierRef == nil {
				latestKO.Spec.EncryptionSpecification.KMSKeyIdentifierRef = desiredKO.Spec.EncryptionSpecification.KMSKeyIdentifierRef
			}
		}
	}
