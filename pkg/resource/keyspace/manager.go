...
import (
	...
	svcsdkapi "github.com/aws/aws-sdk-go/service/keyspaces/keyspacesiface"
...
// +kubebuilder:rbac:groups=keyspaces.services.k8s.aws,resources=keyspaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=keyspaces.services.k8s.aws,resources=keyspaces/status,verbs=get;update;patch
