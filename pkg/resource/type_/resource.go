...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.TypeName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["typeName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: typeName"))
	}
	r.ko.Spec.TypeName = &tmp
