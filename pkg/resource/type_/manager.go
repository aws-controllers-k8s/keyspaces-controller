...
// +kubebuilder:rbac:groups=keyspaces.services.k8s.aws,resources=types,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=keyspaces.services.k8s.aws,resources=types/status,verbs=get;update;patch
