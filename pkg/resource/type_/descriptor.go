...
const (
	FinalizerString = "finalizers.keyspaces.services.k8s.aws/Type"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("types")
